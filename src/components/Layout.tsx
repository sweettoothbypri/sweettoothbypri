          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-warm-cream/80 font-body text-sm leading-relaxed">
                Personalised, healthy & affordable sweet creations made with love.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="tel:+918454830444"
                  className="flex items-center gap-2 text-warm-cream/80 hover:text-blush transition-colors text-sm font-body"
                >
                  <Phone size={16} />
                  +91 8454830444
                </a>
                <a
                  href="mailto:priyankacreatesmagic@gmail.com"
                  className="flex items-center gap-2 text-warm-cream/80 hover:text-blush transition-colors text-sm font-body"
                >
                  <Mail size={16} />
                  priyankacreatesmagic@gmail.com
                </a>
              </div>
            </div>
          </div>
