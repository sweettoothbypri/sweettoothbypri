        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto">
          ...
          <div className="bg-card rounded-2xl p-6 text-center border border-border hover:shadow-lg transition-shadow">
            ...
            <div className="bg-background rounded-xl p-3 inline-block mb-3">
              <QRCodeSVG
                value="https://wa.me/918454830444"
                size={140}
                bgColor="transparent"
          ...
          <div className="bg-card rounded-2xl p-6 text-center border border-border hover:shadow-lg transition-shadow">
            ...
            <div className="bg-background rounded-xl p-3 inline-block mb-3">
              <QRCodeSVG
                value="https://instagram.com/YOUR_INSTAGRAM_HANDLE"
                size={140}
                bgColor="transparent"
                fgColor="hsl(20, 25%, 15%)"
              />
            ...
            <p className="text-muted-foreground font-body text-xs italic">
              Update with your Instagram link
            </p>
          </div>
